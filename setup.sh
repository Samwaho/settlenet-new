...
docker-compose run --rm certbot certonly --webroot --webroot-path=/var/www/certbot --email wahomesamuel2003@gmail.com --agree-tos --no-eff-email -d settlenet.co.ke -d www.settlenet.co.ke
